...
llm:
  api_key_env: string (environment variable name for API key, e.g., GEMINI_API_KEY, OPENAI_API_KEY, ANL_USER)
...
13. For ANL Argo: use api_type="openai", api_key_env="ANL_USER", base_url="https://apps-dev.inside.anl.gov/argoapi/v1/", models like "gpt4o", "gemini25flash", "claudesonnet4"
